...
SendMail = {
  ...
  prepareMail: function (emailFields) {
    ...
    return new helper.Mail(new helper.Email(emailFields.from), emailFields.subject, new helper.Email(emailFields.to), new helper.Content('text/plain', emailFields.body))
  },
